...
<body class="cover" style="background-image: url('<?= base_url("assets/img/loginFont.jpg")?>');">
	<form action=" <?= base_url('home/index') ?>" method="POST" autocomplete="off" class="full-box logInForm">
